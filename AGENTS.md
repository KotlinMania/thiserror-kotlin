...
This file is the quick-reference operating contract for thiserror-kotlin. The longer
...
thiserror-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`thiserror`](https://crates.io/crates/thiserror). Upstream Rust is the behavioral oracle while the
