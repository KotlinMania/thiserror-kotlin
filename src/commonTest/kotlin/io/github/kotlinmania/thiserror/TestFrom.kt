...
class TestFrom {
    ...
    private data class ErrorStruct(val source: IoError) : Error {
        override fun source(): Error = source
    ...
    private data class ErrorStructOptional(val source: IoError?) : Error {
        override fun source(): Error? = source
    ...
    private data class ErrorTuple(val source: IoError) : Error {
        override fun source(): Error = source
    ...
    private data class ErrorTupleOptional(val source: IoError?) : Error {
        override fun source(): Error? = source
    ...
    private sealed class ErrorEnum : Error {
    ...
    private sealed class ErrorEnumOptional : Error {
    ...
    private sealed class Many : Error {
