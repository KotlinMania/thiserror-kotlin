...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `Thiserror.swiftmodule/`
...
//      `import Thiserror` above would fail at compile time.
//
//   2. The static archive `libThiserror.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "Thiserror" }` and
//      `flattenPackage = "io.github.kotlinmania.thiserror"` configuration in
...
//      via the `ThiserrorLibrary` product.
//
