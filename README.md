# thiserror-kotlin in Kotlin

[![GitHub link](https://img.shields.io/badge/GitHub-KotlinMania%2Fthiserror--kotlin-blue.svg)](https://github.com/KotlinMania/thiserror-kotlin)
[![Maven Central](https://img.shields.io/maven-central/v/io.github.kotlinmania/thiserror-kotlin)](https://central.sonatype.com/artifact/io.github.kotlinmania/thiserror-kotlin)
[![Build status](https://img.shields.io/github/actions/workflow/status/KotlinMania/thiserror-kotlin/ci.yml?branch=main)](https://github.com/KotlinMania/thiserror-kotlin/actions)

This is a Kotlin Multiplatform line-by-line transliteration port of [`dtolnay/thiserror`](https://github.com/dtolnay/thiserror).

**Original Project:** This port is based on [`dtolnay/thiserror`](https://github.com/dtolnay/thiserror). All design credit and project intent belong to the upstream authors; this repository is a faithful port to Kotlin Multiplatform with no behavioural changes intended.
...
## Upstream README — `dtolnay/thiserror`

> The text below is reproduced and lightly edited from [`https://github.com/dtolnay/thiserror`](https://github.com/dtolnay/thiserror). It is the upstream project's own description and remains under the upstream authors' authorship; links have been rewritten to absolute upstream URLs so they continue to resolve from this repository.
...
```kotlin
dependencies {
    implementation("io.github.kotlinmania:thiserror-kotlin:0.1.0-SNAPSHOT")
}
```
...
This Kotlin port is distributed under the same MIT license as the upstream [`dtolnay/thiserror`](https://github.com/dtolnay/thiserror). See [LICENSE](LICENSE) (and any sibling `LICENSE-*` / `NOTICE` files mirrored from upstream) for the full text.
...
Thanks to the [`dtolnay/thiserror`](https://github.com/dtolnay/thiserror) maintainers and contributors for the original Rust implementation. This port reproduces their work in Kotlin Multiplatform; bug reports about upstream design or behavior should go to the upstream repository.
