...
kotlin {
    ...
    val xcf = XCFramework("Thiserror")

    macosArm64 {
        binaries.framework { baseName = "Thiserror"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "Thiserror"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "Thiserror"
        flattenPackage = "io.github.kotlinmania.thiserror"
    }

    android {
        namespace = "io.github.kotlinmania.thiserror"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "thiserror-kotlin", version.toString())

    pom {
        name.set("thiserror-kotlin")
        description.set("Kotlin Multiplatform port of dtolnay/thiserror - derive(Error)")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/thiserror-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/thiserror-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/thiserror-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/thiserror-kotlin.git")
        }
    }
}
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleThiserrorXCFramework",
    "assembleThiserrorDebugXCFramework",
    "assembleThiserrorReleaseXCFramework",
    "assembleDebugIosFatFrameworkForThiserrorXCFramework",
    "assembleReleaseIosFatFrameworkForThiserrorXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForThiserrorXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForThiserrorXCFramework",
    "assembleDebugMacosFatFrameworkForThiserrorXCFramework",
    "assembleReleaseMacosFatFrameworkForThiserrorXCFramework",
    "assembleDebugTvosFatFrameworkForThiserrorXCFramework",
    "assembleReleaseTvosFatFrameworkForThiserrorXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForThiserrorXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForThiserrorXCFramework",
    "assembleDebugWatchosFatFrameworkForThiserrorXCFramework",
    "assembleReleaseWatchosFatFrameworkForThiserrorXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForThiserrorXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForThiserrorXCFramework",
